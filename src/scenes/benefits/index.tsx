...
const Benefits = ({setSelectedPage}: Props) => {
  return <section
  id='benefits'
  className="mx-auto min-h-full w-5/6 py-20 bg-white">
    <motion.div
    onViewportEnter={()=>setSelectedPage(SelectedPage.Benefits)}>
        ...
        className="md:w-3/5 md:my-5">
            ...
            <p className="my-5 text-sm">
                We provide world class fitness equipement, trainers and classes to 
                get you to your ultimate fitness goals with ease. We provide a true care 
